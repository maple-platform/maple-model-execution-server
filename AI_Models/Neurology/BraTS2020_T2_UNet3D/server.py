#!/usr/bin/env python3
"""FastAPI inference server for BraTS2020 T2 UNet3D segmentation.
...
logger = logging.getLogger("maple.brats_t2")
...
app = FastAPI(title="BraTS2020 T2 UNet3D Inference Server")
...
@app.get("/health")
async def health():
    return {"status": "ok", "service": "brats-t2-inference"}
