# BraTS2020 Brain Tumor Segmentation — T1
...
| 항목 | 타입 | 설명 |
|------|------|------|
| input_data | nifti | T1 MRI NIfTI 파일 (.nii.gz) |
...
| 파일 | 설명 |
|------|------|
| checkpoint/best.pt | T1 모달리티 학습 가중치 |
...
results = main(
    input_data="sample_data/sample_01_t1.nii.gz",
