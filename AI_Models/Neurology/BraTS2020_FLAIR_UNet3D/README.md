# BraTS2020 Brain Tumor Segmentation — FLAIR

## 개요
- **진료과**: Neurology / Radiology
- **모달리티**: FLAIR (Fluid-Attenuated Inversion Recovery)
- **모델 타입**: standalone
...
| 항목 | 타입 | 설명 |
|------|------|------|
| input_data | nifti | FLAIR (Fluid-Attenuated Inversion Recovery) MRI NIfTI 파일 (.nii.gz) |
...
| 파일 | 설명 |
|------|------|
| checkpoint/best.pt | FLAIR 모달리티 학습 가중치 |
...
results = main(
    input_data="sample_data/sample_01_flair.nii.gz",
