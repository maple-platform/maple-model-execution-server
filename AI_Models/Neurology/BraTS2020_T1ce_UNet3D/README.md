# BraTS2020 Brain Tumor Segmentation — T1ce

## 개요
- **진료과**: Neurology / Radiology
- **모달리티**: T1ce (T1 Contrast-Enhanced)
- **모델 타입**: standalone
...
| 항목 | 타입 | 설명 |
|------|------|------|
| input_data | nifti | T1ce (T1 Contrast-Enhanced) MRI NIfTI 파일 (.nii.gz) |
...
| 파일 | 설명 |
|------|------|
| checkpoint/best.pt | T1ce 모달리티 학습 가중치 |
...
results = main(
    input_data="sample_data/sample_01_t1ce.nii.gz",
