#!/usr/bin/env python3
"""FastAPI inference server for BraTS2020 T1ce UNet3D segmentation.
...
logger = logging.getLogger("maple.brats_t1ce")
...
app = FastAPI(title="BraTS2020 T1ce UNet3D Inference Server")
...
@app.get("/health")
async def health():
    return {"status": "ok", "service": "brats-t1ce-inference"}
