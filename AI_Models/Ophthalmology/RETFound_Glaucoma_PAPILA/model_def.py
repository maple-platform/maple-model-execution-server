"""Minimal RETFound-MAE ViT definition adapted from rmaphoh/RETFound_MAE.

Original project: https://github.com/rmaphoh/RETFound_MAE
License: CC BY-NC 4.0. Changes: isolated the MAE ViT used for inference.
Identical to the RETFound_DR_APTOS2019_GradCAM package's model_def.py -- same
backbone, different fine-tuned checkpoint and classification head size.
"""
