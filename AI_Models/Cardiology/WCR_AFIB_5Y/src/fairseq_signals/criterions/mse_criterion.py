...
class MSECriterionConfig(Dataclass):
    ...
    report_auc: Optional[bool] = field(default=False,metadata={"help": "For retro compatibility"})
    report_cinc_score: Optional[bool] = field(default=False,metadata={"help": "For retro compatibility"})
