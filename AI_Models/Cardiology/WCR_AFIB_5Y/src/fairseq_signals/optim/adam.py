...
from fairseq_signals.optim import Optimizer, register_optimizer
from omegaconf import II, OmegaConf

logger = logging.getLogger(__name__)

@dataclass
class AdamConfig(Dataclass):
    ...
    use_old_adam: bool = field(
        default = False, metadata = {"help": "Use fairseq_signals.optim.adam.Adam"}
    )
