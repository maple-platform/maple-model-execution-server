# RSNA 2024 Neural Foraminal Crop

Three-class neural-foraminal narrowing grading from a coordinate-centered, 96 mm, three-adjacent-slice sagittal T1 crop. Input is either the prepared RGB PNG (channels are previous/current/next slices) or a directory containing exactly three ordered image/DICOM slices.
...
| Index | Content |
|---|---|
| `[0]` | Input crop annotated with neural foraminal narrowing grade |
