# RSNA 2024 Subarticular Crop

Three-class subarticular stenosis grading from a coordinate-centered, 96 mm, three-adjacent-slice axial T2 crop. Input is either the prepared RGB PNG (channels are previous/current/next slices) or a directory containing exactly three ordered image/DICOM slices.
...
| Index | Content |
|---|---|
| `[0]` | Input crop annotated with subarticular stenosis grade |
